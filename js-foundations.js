...
let numChecker = (number) =>{
    if(number%3 ===0){
     return number + " is a divisible by 3"
     }else
...
var helloMe = {
    ...
    height: "6'2",
    eyes: "blue",
    getData: function() {return this.firstName + " " + this.lastName + " is " + this.height + " and has " + this.eyes + " eyes."}
};
...
let allLetters = (arr, arr2, arr3) =>{
    let newArr = arr+arr2+arr3
    return newArr.split('').sort().join('')
}

console.log(allLetters(testString1, testString2, testString3))
